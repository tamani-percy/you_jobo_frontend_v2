...
const {createJobApplicationMutation, createJobApplication} = useJobApplications()
...
const schema = z
    ...
    .superRefine((data, ctx) => {
      ...
      // company conditional validation
      if (data.alreadySavedCompany) {
        if (!data.selectedCompanyId || !data.selectedCompanyId) {
          ctx.addIssue({
            code: z.ZodIssueCode.custom,
...
<template>
  <UModal
      ...
      description="All the necessary goodies that make your job application comprehensive."
  >
    <UButton
        icon="i-lucide-plus"
      ...
      >
          ...
          <template #job>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <UFormField label="Job Application Status" name="jobApplicationStatus" required>
                <USelect v-model="state.jobApplicationStatus" :items="JobApplicationStatus" class="w-full"
              ...
              <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                  <UFormField label="Company Description" name="companyDescription" required>
                    <UTextarea v-model="state.companyDescription" :rows="5" class="w-full"
        ...
        <div class="flex items-center justify-between pt-4">
          ...
          <div>
            ...
            <UButton
                :loading="createJobApplicationMutation.isLoading.value"
                v-else
                type="submit"
            >
              Submit
